  ...
  template: `
    ...
    <ion-content>
      <ion-grid class="container">
        ...
        <ion-row>
          <ion-col size="12">
            <form #form="ngForm" [formGroup]="resetPasswordForm" (ngSubmit)="resetPassword()" method="post">
              <ion-item>
                <ion-label position="floating">Current Password</ion-label>
                <ion-input ngModel type="password" name="currentPassword" formControlName="currentPassword"></ion-input>
              </ion-item>
              <ion-item>
                <ion-label position="floating">Password</ion-label>
                <ion-input ngModel type="password" name="password" formControlName="newPassword"></ion-input>
              </ion-item>
              <ion-button type="submit" expand="full" color="primary">Change Password</ion-button>
            </form>
          </ion-col>
        </ion-row>
      </ion-grid>
...
export class ResetPasswordComponent implements OnInit {
  ...
  resetPassword(): void {
    if (this.resetPasswordForm.valid) {
      this.store.dispatch(new ResetPasswordAction(this.resetPasswordForm.value));
    }
  }
}
